...
def vgg_11(logits=False, input_ph=None, img_rows=28, img_cols=28,
    ...
    # here we construct the neural network
    ...
    layers = [Dropout(0.2, input_shape=input_shape),
              ...
              MaxPooling2D((2,2)),
              Activation('relu'),
              conv_2d((nb_filters * 2), (3, 3), (1, 1), "same"),
              Activation('relu'),
              MaxPooling2D((2,2)),
              Activation('relu'),
              conv_2d((nb_filters * 4), (3, 3), (1, 1), "same"),
              Activation('relu'),
              MaxPooling2D((2,2)),
              Activation('relu'),
              conv_2d((nb_filters * 8), (3, 3), (1, 1), "same"),
              Activation('relu'),
              MaxPooling2D((2,2)),
              Activation('relu'),
              conv_2d((nb_filters * 8), (3, 3), (1, 1), "same"),
